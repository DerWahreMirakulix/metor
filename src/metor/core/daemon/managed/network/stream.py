...
class TcpStreamReader:
    ...
    def __init__(
        ...
        Args:
            ...
            initial_buffer (bytes): Any leftover byte buffer from previous reads.
        ...
        self._buffer: bytearray = bytearray(initial_buffer)
    ...
    def read_line(self) -> Optional[str]:
        ...
        Raises:
            ...
            ConnectionError: If the received frame is not valid UTF-8.
        ...
        try:
            ...
            raise ConnectionError('Invalid UTF-8 data in TCP stream.') from exc
    ...
    def get_buffer(self) -> bytes:
        ...
        Returns:
            bytes: The remaining byte buffer.
        """
