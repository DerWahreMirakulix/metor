...
class Help:
    ...
    @staticmethod
    def show_chat_help(start=0, intend=2, additional_empty_line=False): 
        ind = ' ' * intend * start
        ...
        out = (
            ...
            + f"{sub_ind}{Settings.PURPLE}Chat Mode Core:{Settings.RESET}\n"
            ...
            + f"{sub_ind}{Settings.PURPLE}Chat Mode Contacts:{Settings.RESET}\n"
    ...
    def show_main_help(start=0, intend=2):
        ...
        return (
            ...
            + Help._format_line(sub_ind, "metor help", "Show this professional help overview.", Help.DESC_COLUMN)
            ...
            + f"{ind}------------------------------------------\n\n"
            + Help.show_chat_help(start + 1, intend=intend, additional_empty_line=True)
            + f"{ind}------------------------------------------\n\n"
            ...
            + f"{ind}{Settings.YELLOW}Contact Management:{Settings.RESET}\n"
            ...
            + Help._format_line(sub_ind, "metor contacts rename <old> <new>", "Rename a saved contact or active session.", Help.DESC_COLUMN)
        )
