...
class Help:
    ...
    def show_chat_help(): 
        return (
            ...
            f"  {Settings.CYAN}/contacts [list|add|rm|rename] ..options{Settings.RESET}                     - Manage your address book.\n"
    ...
    def show_main_help():
        return (
            ...
            f"  {Settings.CYAN}metor daemon{Settings.RESET}                                                 - Start the background Tor daemon.\n"
            f"  {Settings.CYAN}metor chat{Settings.RESET}                                                   - Start chat mode.\n"
            f"  {Settings.CYAN}metor address [show|generate]{Settings.RESET}                                - Show or generate a new onion address.\n"
            f"  {Settings.CYAN}metor history [clear]{Settings.RESET}                                        - Show or clear connection history.\n"
            f"  {Settings.CYAN}metor contacts [list|add|rm|rename] ..options{Settings.RESET}                - Manage your address book.\n"
            f"  {Settings.CYAN}metor profiles [list|add|rm|rename|set-default] ..options{Settings.RESET}    - Manage your profiles.\n"
            f"  {Settings.CYAN}metor cleanup{Settings.RESET}                                                - Clean up Metor processes and locks.\n\n"
            + Help.show_chat_help() +
            "\n  -> Any other text is sent as a chat message to the currently focused peer.\n\n"
            "Examples:\n"
            "  metor contacts add alice abcdef12345...\n"
            "  metor profiles rename default my_main_profile\n"
        )
